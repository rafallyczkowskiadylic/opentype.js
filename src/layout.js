        ...
        requestedFeatures.forEach(feature => {
            ...
            if (featureTable && supportedLookups.length) {
                ...
                for (let i = 0; i < lookupListIndexes.length; i++) {
                    ...
                    if (lookupTable.lookupType === 9 && (lookupTable.subtables.length > 0)) { 
                        const extLookupType = lookupTable.subtables[0].extensionLookupType;
                        if (supportedLookups.indexOf(extLookupType) !== -1) {
                            lookupTable.lookupType = extLookupType;
